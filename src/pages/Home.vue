<template>
  <div class=" bg-gray-100 w-fit md:w-full m-auto">
    <div class="m-10  ">
      <div class="space-y-5">
        <div class="flex justify-between">
           
          <h1 class=" font-bold mb-7 hidden sm:block">Reports</h1>
          ...
          <button class="sm:hidden block " @click="props.toggleSidebar">
            <PanelLeftClose v-if="isSidebar"/>
            <PanelLeftOpen v-else/>
          </button>
        </div>
        <div class=" border border-gray-200"></div>
        <FilterMenu />
        <div class="space-x-5 flex lg:flex-row flex-col space-y-5 ">
          <InfoCards />
          <Activity />
        </div>
        <div class="space-x-5 flex lg:flex-row flex-col space-y-5 ">
...
import StrongTopics from '../components/cards/Topics/StrongTopics.vue';
